...
# Ground reference
GROUND_Z = 0.3263  # Actual ground height
...
ax1.axhline(y=GROUND_Z, color='brown', linestyle='--', linewidth=2, label='Floor')
ax1.set_xlabel('X (m)')
ax1.set_ylabel('Y (m)')
ax1.set_zlabel('Z (m)')
...
ax2.axhline(y=GROUND_Z, color='brown', linestyle='--', linewidth=2, label='Floor')
ax2.set_xlabel('Y (m)')
ax2.set_ylabel('Z (m)')
...
ax3.axhline(y=GROUND_Z, color='brown', linestyle='--', linewidth=2, label='Floor')
ax3.set_xlabel('X (m)')
ax3.set_ylabel('Z (m)')
...
ax4.axhline(y=GROUND_Z, color='brown', linestyle='--', linewidth=2, label='Floor')
ax4.set_xlabel('Step')
