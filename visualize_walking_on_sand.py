"""
Visualize robot walking on sand using MuJoCo viewer
Shows the robot walking in real-time with interactive controls
"""
import mujoco as mj
...
print("=" * 90)
print(" " * 20 + "ROBOT WALKING ON SAND - MUJOCO VIEWER")
print("=" * 90)
...
target_velocity = 0.40  # m/s
forward_push = 1500.0  # N

print("[+] Starting viewer with robot walking...")
print("[+] Watch the robot walk on sand with both feet in contact")
...
with mujoco.viewer.launch_passive(model, data) as viewer:
    ...
    while viewer.is_running():
        ...
        # Print status every second of simulation
        if t - last_update >= 1.0:
            ...
            try:
                ...
                print(f"t={t:6.1f}s | Step {int(t/gait_period):2d} | X={x_pos:.4f}m | Dist={dist:+.4f}m | L-contact:{l_contact} R-contact:{r_contact}")
            except:
                pass
