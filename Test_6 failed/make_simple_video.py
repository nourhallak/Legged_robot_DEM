#!/usr/bin/env python3
"""
Generate simple video of robot walking on sand
"""
import mujoco as mj
import numpy as np
...
# Setup for rendering
renderer = mj.Renderer(model, height=400, width=400)
...
while sim_time < t_end:
    ...
    # Render every other frame (15fps from 30fps)
    if frame_count % 2 == 0:
...
print(f"Duration: ~{len(frames)/15:.1f}s at 15fps")
