#!/usr/bin/env python3
"""
Walking Trajectory Generator for Biped Robot
...
Z_OSCILLATION_AMP = 0.001       # Hip vertical oscillation amplitude (m) - REDUCED
...
if max_foot_z <= GROUND_Z + SWING_CLEARANCE + 0.001:
...
# Phase diagram
ax = axes[1, 2]
steps_range = np.arange(min(150, NUM_STEPS))
...
print(f"  - walking_trajectories.png")
