...
def complete_pipeline():
    ...
    np.save("base_feasible.npy", base)
    np.save("foot1_feasible.npy", foot1)
    np.save("foot2_feasible.npy", foot2)
    ...
    np.save("q_left_feasible.npy", q_left)
    np.save("q_right_feasible.npy", q_right)
    np.save("err_left_feasible.npy", err_left)
    np.save("err_right_feasible.npy", err_right)
