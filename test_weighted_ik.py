#!/usr/bin/env python3
"""Test: IK with error weighting by target magnitude"""
import mujoco
import numpy as np
...
print("Step 0 with WEIGHTED errors:")
print("Iter | Base Z | Error | dq[2] | Method")
print("-" * 55)
...
for iteration in range(50):
    ...
    # METHOD: Weight each target equally despite scale differences
    # Normalize error vectors for each target, then concatenate
    ...
    if iteration in [0, 1, 5, 10, 20, 49]:
        print(f"{dq_all[2]:10.6f} | Weighted")
